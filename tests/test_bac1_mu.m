...
clf
subplot(2, 2, 1)
histogram(results_gibbs.mu_all, 'EdgeColor', 'none')
line(mu_true * [1 1], ylim)
set(gca, 'box', 'off')
title('gibbs')

subplot(2, 2, 2)
histogram(results_pmala.mu_all, 'EdgeColor', 'none')
line(mu_true * [1 1], ylim)
set(gca, 'box', 'off')
title('pmala')

subplot(2, 2, 3)
histogram(results_pmyula.mu_all, 'EdgeColor', 'none')
line(mu_true * [1 1], ylim)
set(gca, 'box', 'off')
title('pmyula')

subplot(2, 2, 4)
histogram(results_gaussian.mu_all, 'EdgeColor', 'none')
line(var(x_true) * [1 1], ylim)
set(gca, 'box', 'off')
title('gaussian')
