function [ results, misc ] = bac2_pmala(y, H, option, init)
...
if ~isreal(mu_init) || ~isreal(beta_init) || numel(mu_init) > 1 || numel(beta_init) > 1
    error('option.beta should be real and scalar')
end
...
[chain_x, chain_beta, chain_arate] = bac2_pmala_c(...
    y, H, Nit,                  ...
